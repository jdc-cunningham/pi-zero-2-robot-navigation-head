...
const sampleFloorScanSensorCoordinate = {
  ...
  "15-0-r":  [-0.94, 6.71, 0.69],
  "15-20-r": [-0.56, 6.71, 0.94],
  "15-40-r": [-0.27, 6.71, 1.13],
  "15-60-r": [0.13, 6.71, 1.16],
  "15-20-l": [-1.11, 6.71, 0.33],
  "15-40-l": [-1.16, 6.71, -0.07],
  "15-60-l": [-1.07, 6.71, -0.47]
};
...
const sampleFloorScanSensorDistance = {
  ...
  "15-60-r": 28.86,
  "15-20-l": 46.41,
  "15-40-l": 22.62, // 319.41 outlier example, pretty much nothing measured/infinite, cap to largest value in set
  "15-60-l": 23.79
};
