...
base_path = os.getcwd()
img = cv2.imread(base_path + '/panorama/last/pan_crop_output.jpg')
...
# hsv
mask = cv2.inRange(hsv, (0, 100, 0), (10, 255, 190)) # apply mask to non-black pixels, 2 vs. 1 is a little better
cv2.imwrite(base_path + '/panorama/pan_crop_output_mask_applied.jpg', mask)